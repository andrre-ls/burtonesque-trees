export const genomeStructure = {
	...
	trunk_range_x: { default: 50, max: 75, min: 5, step: 1 },
	// *
	// how far vertically from the last node each new trunk node can be randomly placed
	trunk_range_y: { default: 50, max: 75, min: 15, step: 1 },
	// *
	...
	trunk_roughness: { default: 4, max: 15, min: 1, step: 1 },
	// *
	// probability of sprouting a branch at each body node
	branch_prob: { default: 0.7, max: 0.99, min: 0, step: 0.0025 },
	// *
	...
	stop_branch_prob: { default: 0.2, max: 0.5, min: 0, step: 0.05 },
	// *
	...
	branch_roughness: { default: 2, max: 15, min: 1, step: 1 },
};
